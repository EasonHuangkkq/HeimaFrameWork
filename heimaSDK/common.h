...
// ==========================================
// [RxPDO 0x1601] Memory Alignment for MT_Device
// Total Size: 24 Bytes
// ==========================================
struct __attribute__((packed)) DriverRxData{
    ...
    int PvtKp;                  // 0x2000 (32 bit) - Offset 12
    int PvtKd;                  // 0x2001 (32 bit) - Offset 16
    char Mode;                  // 0x6060 (8 bit)  - Offset 20
    signed char Undefined;      // 0x2FFD (8 bit)  - Offset 21 (Padding)
};

// ==========================================
// [TxPDO 0x1A02] Memory Alignment for MT_Device
// Total Size: 22 Bytes
// ==========================================
struct __attribute__((packed)) DriverTxData{
    ...
    short MotorTemperature;     // 0x2009 (16 bit) - Offset 14
    short DriveTemperature;     // 0x200C (16 bit) - Offset 16
    unsigned short Voltage;     // 0x200A (16 bit) - Offset 18
    char ModeDisplay;           // 0x6061 (8 bit)  - Offset 20
    signed char Undefined;      // 0x2FFE (8 bit)  - Offset 21 (Padding)
};
